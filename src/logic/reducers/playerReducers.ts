...
// 	playerDisplayName: "Guest Player",
// 	playerEmail: "guest@cityquest.app"
// };
...
// 	switch (action.type) {
// 		case SIGN_IN:
// 			return { ...guestPlayer, playerDisplayName: "Angus" };
// 		case SIGN_OUT:
...
// 			return { ...player, playerDisplayName: action.payload }; // TODO update cache, remote, and return updated player
